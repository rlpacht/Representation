...
class PoliticiansController < ApplicationController
  ...
  def top_contributors
    ...
    sorted = @politician.top_contributors({
      cycle: cycle,
      limit: limit,
      id: @politician.id
    })
  ...
  def total_raised_in_cycle
    ...
    total = @politician.total_from_cycle({
      cycle: cycle,
      id: @politician.id
    })
  ...
  def pac_money
    ...
    @politician = Politician.find_by_name(politician_name)
    pacs = @politician.money_from_pacs({
      cycle: cycle,
      id: @politician.id
    })
  ...
  def contributions_by_gender
    ...
    @politician = Politician.find_by_name(politician_name)
    contributions_from_genders = @politician.gender_contributions({
      cycle: cycle,
      id: @politician.id
    })
